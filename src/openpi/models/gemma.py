...
class RMSNorm(nn.Module):
    ...
    def __call__(self, x, cond):
        ...
        # adaptive RMSNorm. cond may be [b, w] (one vector per sequence -- stock pi05
        # flow-time conditioning) or [b, s, w] (per-TOKEN conditioning, needed by TT-RTC
        # where prefix action tokens carry a different flow time than postfix tokens).
        # Both broadcast against x [b, s, w].
