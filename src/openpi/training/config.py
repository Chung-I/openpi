...
_CONFIGS = [
    ...
    TrainConfig(
        name="pi0_mem_droid_stream_bench",
        exp_name="pi0_mem_droid_stream_bench",
        model=pi0_mem_config.Pi0MEMConfig(
            pi05=True,
            action_dim=32,
            action_horizon=50,
    ...
    TrainConfig(
        name="pi0_mem_droid_local",
        exp_name="pi0_mem_droid_local",
        model=pi0_mem_config.Pi0MEMConfig(
            pi05=True,
            action_dim=32,
            action_horizon=50,
        ...
        data=RLDSDroidDataConfig(
            repo_id="droid",
            rlds_data_dir="/work/roboleon1295/openpi/data/droid_subset",
            action_space=droid_rlds_dataset.DroidActionSpace.JOINT_POSITION,
            datasets=(
                droid_rlds_dataset.RLDSDataset(
                    name="droid",
